...
__attribute__ ((section("vectors")))= {
    ...
    (unsigned int *)  reset_mcu, // 14 PendSV
    (unsigned int *)  systick_int, // 15 compteur systick    
    // --------  IRQ ------------
    (unsigned int *)  reset_mcu, // 0 WWDG
    (unsigned int *)  reset_mcu, // 1 PVD
    (unsigned int *)  reset_mcu, // 2 TAMPER
    (unsigned int *)  RTC_handler, // 3 RTC
    (unsigned int *)  reset_mcu, // 4 FLASH
    (unsigned int *)  reset_mcu, // 5 RCC
    (unsigned int *)  reset_mcu, // 6 EXTI0
    (unsigned int *)  reset_mcu, // 7 EXTI1
    (unsigned int *)  reset_mcu, // 8 EXTI2
    (unsigned int *)  reset_mcu, // 9 EXTI3
    (unsigned int *)  reset_mcu, // 10 EXTI4
    (unsigned int *)  reset_mcu, // 11 DMA1CH1
    (unsigned int *)  reset_mcu, // 12 DMA1CH2
