...
// champs APB2RSTR
#define RCC_ABP2RSTR_AFIORST (1<<0)
#define RCC_ABP2RSTR_IOPARST (1<<2)
#define RCC_ABP2RSTR_IOPBRST (1<<3)
#define RCC_ABP2RSTR_IOPCRST (1<<4)
#define RCC_ABP2RSTR_IOPDRST (1<<5)
#define RCC_ABP2RSTR_IOPERST (1<<6)
#define RCC_ABP2RSTR_IOPFRST (1<<7)
#define RCC_ABP2RSTR_IOPGRST (1<<8)
#define RCC_ABP2RSTR_ADC1RST (1<<9)
#define RCC_ABP2RSTR_ADC2RST (1<<10)
#define RCC_ABP2RSTR_TIM1RST (1<<11)
#define RCC_ABP2RSTR_SPI11RST (1<<12)
#define RCC_ABP2RSTR_TIM8RST (1<<13)
#define RCC_ABP2RSTR_USART1RST (1<<14)
#define RCC_ABP2RSTR_ADC3RST (1<<15)
#define RCC_ABP2RSTR_TIM9RST (1<<19)
#define RCC_ABP2RSTR_TIM10RST (1<<20)
#define RCC_ABP2RSTR_TIM11RST (1<<21)
